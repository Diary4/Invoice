...
export function ReceiptVoucherViewer({ voucher, companyInfo, onEdit, onDownloadPDF, onBack }: ReceiptVoucherViewerProps) {
          ...
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Receipt Voucher Details</p>
              </div>
            </div>
        ...
        <CardContent className="space-y-8">
          ...
          <div className="flex justify-between items-start border-b pb-6">
            ...
            <div className="text-right">
              <h1 className="text-3xl font-bold text-gray-800">RECEIPT VOUCHER</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {voucher.customer && (
              <div>
                <h3 className="font-semibold text-primary mb-3">Received From:</h3>
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{new Date(voucher.receiptDate).toLocaleDateString()}</span>
              </div>
              <div className="flex justify-between">
          ...
          {/* Signature Section */}
          {(voucher.deliveredBy || voucher.receivedBy) && (
            <div className="border-t pt-6">
              <div className="grid grid-cols-2 gap-8 mt-6">
                {voucher.deliveredBy && (
                  <div>
                    <p className="font-semibold mb-2">{voucher.deliveredBy}</p>
                ...
                {voucher.receivedBy && (
                  <div>
                    <p className="font-semibold mb-2">{voucher.receivedBy}</p>
                    <div className="border-t border-b border-gray-300 py-8 mb-2">
                      <p className="text-xs text-muted-foreground mb-4">Signature</p>
                    </div>
                    <div className="border-t border-b border-gray-300 py-2">
          ...
          <div className="border-t pt-6 text-center text-sm text-muted-foreground">
            ...
            <p>For questions about this receipt, please contact us at {companyInfo.email}</p>
          </div>
        </CardContent>
      </Card>
    </div>
